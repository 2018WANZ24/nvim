...
require 'diffview'.setup {
  ...
  key_bindings = {
    ...
    file_panel = {
      ["e"]             = cb("next_entry"), -- Bring the cursor to the next file entry
      ["<down>"]        = cb("next_entry"),
      ["u"]             = cb("prev_entry"), -- Bring the cursor to the previous file entry.
      ["<up>"]          = cb("prev_entry"),
      ...
      ["k"]             = cb("listing_style"), -- Toggle between 'list' and 'tree' views
